async function loadStats() {
    ...
    // Тут можна додати код для оновлення інформації про диск,
    // коли ви додасте цю функціональність до серверної частини
}

// Функція для форматування байтів у більш читабельний формат
